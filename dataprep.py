# This is the data prep file for the train
import glob
import torch
import pdb
import os
...
def data_load(args,datatype):
    ...
    if datatype=='Train':
        shuffle=True
        data = TrainData(args.file_path)
        
        
    elif datatype=='Validation':
        data = ValidData(args.file_path_validation)
        shuffle= False
    
    elif datatype=='Test':
        data = TestData(args.file_path_test)
        shuffle= False
    else:
...
class TrainData(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
                ...
                transindex = idx % 2 #/ len(self.files)
